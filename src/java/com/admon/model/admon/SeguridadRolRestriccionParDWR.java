 ...
 * @param seguridadRestriccionesRolList Lista de registros que se eliminarán en la tabla de <b>Seguridad_Rol_Restriccion_Par</b> en la BD.
     */
    public void remove(List<Integer> seguridadRestriccionesRolIdList) {
        seguridadRestriccionesRolBss.delete(obtieneSessionVar().getUsuarioId(), seguridadRestriccionesRolIdList);
    }
 ...
 * registro con ese nombre regresa un <b>true</b>.
    ...
    public boolean isValidoNombre(String nombre) {
        return seguridadRestriccionesRolBss.isValidoNombre(nombre);
    }
 ...
 * @return Regrega un objeto <b>Grid</b> con los datos a mostrar en la pantalla.
    ...
    public Grid findByCriteria(int p, int maxResult, String order, String ordenTipo, SeguridadRolRestriccionPar seguridadRestriccionesRol) {
        return seguridadRestriccionesRolBss.findByCriteria(p, maxResult, order, ordenTipo, seguridadRestriccionesRol);
    }
 ...
 * quiere actualizar su Estatus.
     */
   /* public void setEstatus(Integer estatusId, List<Integer> seguridadRestriccionesRolList) {
        seguridadRestriccionesRolBss.setEstatus(obtieneSessionVar().getUsuarioId(), estatusId, seguridadRestriccionesRolList);
    }*/
 ...
 * una edición de datos en un popup externo.
    ...
    public String getReportDataTest(String order, String ordenTipo, SeguridadRolRestriccionPar seguridadRestriccionesRol) {
        return seguridadRestriccionesRolBss.getReportDataTest(order, ordenTipo, seguridadRestriccionesRol);
    }
    
    /**
     * Método que obtiene los módulos de acuerdo al idAplicación
     *
     * @return regresa el primer resultado de la consulta, si no hay resultados
     * regresa null
     */
    public List<Modulo> getModulosByAplicacion(int aplicacionId) {
        return seguridadRestriccionesRolBss.getModulosByAplicacion(aplicacionId);
    }
    /*
