...
public class CatalogoParametroDWR extends BaseModel {
    ...
    public List<Integer> saveCatalogoParametro(Integer catalogoId, Integer organizacionId, List<CatalogoParametro> catalogoParametroList) {
     ...
     */
    public List<Integer> update(List<CatalogoParametro> catalogoParametroList) {
     ...
     */
    public void remove(List<Integer> catalogoParametroIdList) {
     ...
     */
    public void setEstatus(Integer estatusId, List<CatalogoParametro> catalogoParametroList) {
     ...
     */
    public void setVisible(Integer visible, List<CatalogoParametro> catalogoParametroList) {
