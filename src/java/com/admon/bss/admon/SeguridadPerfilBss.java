 ...
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se actualizarán en la tabla de <b>SeguridadPerfil</b> en la BD.
     */
    public List<Integer> update(Integer userId, List<SeguridadPerfil> seguridadPerfilList);

    /*
 * Método que elimina el registro <b>seguridadPerfil</b> en la tabla de <b>SeguridadPerfil</b>.
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se eliminarán en la tabla de <b>SeguridadPerfil</b> en la BD.
     */
